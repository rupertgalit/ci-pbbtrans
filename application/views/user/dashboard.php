...
<body class="" id="body">
    ...
    <div class="container-scroller">
        ...
        <?php $this->load->view('./user/partials/_sidebar.php'); ?>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <?php $this->load->view('./user/partials/_navbar.php'); ?>
                        ...
                        <div class="col-md-4 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body" >
                                    ...
                                    <img class="center"  src=<?php echo base_url("assets/images/dp.jpg"); ?> alt="">
                      ...
                      <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                        <h6 class="font-weight-bold mb-0">$236</h6>
                                    ...
                                    <div class="col-12 grid-margin">
                                        <div class="card">
                                            <div class="card-body">
                                                <form class="form-sample" action="/action_page.php">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group row">
                                                                <!-- <label>File upload</label> -->
                                                                <input type="file" name="img[]" id="image-input"
                                                                    class="file-upload-default" accept="image/jpeg, image/png, image/jpg">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form class="form-sample" method="post"
                                                    action="<?php echo base_url('AuthController/reg_profile'); ?>">
                                ...
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="membershipRadios" id="membershipRadios2" value="option2"> Professional </label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Unit/St</label>
                                                                <div class="col-sm-9">
